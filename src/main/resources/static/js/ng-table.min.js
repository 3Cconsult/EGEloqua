...
angular.module('ngTable').run(['$templateCache', function ($templateCache) {
	...
	$templateCache.put('ng-table/headerCheckbox.html', '<input class="select-all ng-pristine ng-untouched ng-valid ng-scope" type="checkbox" ng-click="tab1.isEditing = true">');
	}]);
