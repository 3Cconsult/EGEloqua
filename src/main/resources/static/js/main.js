...
(function () {
	...
	angular.module("myApp").controller("accountTableController", accountTableController);
	accountTableController.$inject = ["NgTableParams", "Account"];
	function accountTableController(NgTableParams, Account) {
		var self = this;
